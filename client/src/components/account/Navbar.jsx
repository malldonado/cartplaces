    ...
    <div>
      <nav className="bg-white">
        <div className="h-16 flex mx-auto px-2 sm:px-6 lg:px-8 max-w-[1200px] flex-wrap justify-center items-center">
          ...
          <p className="flex font-sans text-[18px] mx-[90px] cursor-pointer">
            ...
            <IoSearch className="fill-[#2144e1] text-[25px] mr-12 cursor-pointer" />
            {/* <input placeholder="Search..." className="mx-1 h-[25px] p-1 outline-none border border-[#2144e1]"/> */}
          <RiShoppingBag3Line className="fill-[#2144e1] text-[25px] mr-12 cursor-pointer"/>
          <img
            className="border-solid border-spacing-[2px] rounded-xl border-[#243c5a] w-[26px] cursor-pointer"
            src={Profile}
            alt=""
          />
        </div>
